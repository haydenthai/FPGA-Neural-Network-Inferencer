set_property SRC_FILE_INFO {cfile:{Z:/workplace/nn_accelerator/Neural Network Accelerator.srcs/constrs_1/new/basys.xdc} rfile:{../../../Neural Network Accelerator.srcs/constrs_1/new/basys.xdc} id:1} [current_design]
